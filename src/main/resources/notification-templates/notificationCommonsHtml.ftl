        	...
        	<td>
                [#if showTitleStatus]
                    [#if buildSummary??]
                        ...
                        [/#if]
                        [@notificationTitleStatus baseUrl=baseUrl status=getBuildStatus(buildSummary) build=buildSummary.plan buildResultKey=buildSummary.buildResultKey buildNumber=buildSummary.buildNumber statusMessage=statusText /]
                ...
                <tr>
                    <td id="title-status-icon">
                        [#if status == "successful"]
                            <img src="${baseUrl}/images/iconsv3/plan_successful_16.png" alt="Successful">
                        [#elseif status == "failed"]
                            <img src="${baseUrl}/images/iconsv3/plan_failed_16.png" alt="Failed">
                        [#else]
                            <img src="${baseUrl}/images/iconsv3/plan_canceled_16.png" alt="Unknown">
                        [/#if]
                    </td>
    ...
    <tr>
        <td class="status-icon">
            ...
            [#elseif jobResult.failed]
                <img src="${baseUrl}/images/iconsv3/plan_failed_16.png" alt="Failed">
            [#else]
                <img src="${baseUrl}/images/iconsv3/plan_canceled_16.png">
            [/#if]
        </td>
        <td class="[#if jobResult.successful]successful[#elseif jobResult.failed]failed[#else]cancelled[/#if]">
            <a href="${baseUrl}/browse/${jobResult.planResultKey}/">${jobResult.plan.buildName}</a>
...
[#macro showCommits buildSummary baseUrl='']
    [#if buildSummary.commits?has_content]
        ...
        [/#assign]
        [@sectionHeader baseUrl "${baseUrl}/browse/${buildSummary.buildResultKey}/commit/" "Code Changes" utilText/]
        <table width="100%" cellpadding="0" cellspacing="0" class="commits">
            [#if buildSummary.repositoryChangesets?has_content]
                ...
                [#if buildSummary.commits?size gt 3]
                    <tr>
                        <td colspan="3">
                            <a href="${baseUrl}/browse/${buildSummary.buildResultKey}/commit">${buildSummary.commits?size - 3} more changes&hellip;</a>
                        </td>
                    </tr>
                [/#if]
            [#else]
...
[#macro showTests buildSummary baseUrl testResults showJob=true]
    ...
    [#if hasExistingFailedTests || hasNewlyFailingTests || hasFixedTests]
        [@sectionHeader baseUrl "${baseUrl}/browse/${buildSummary.buildResultKey}/test" "Tests" "View full test details" /]
        [#if hasNewlyFailingTests]
            [@displayTestList "New Test Failures" testSummary.newFailedTestCaseCount testResults.newFailedTests "${baseUrl}/images/iconsv3/plan_failed_16.png" baseUrl numTests maxTests showJob/]
        [/#if]
        [#if hasExistingFailedTests]
            [@displayTestList "Existing Test Failures" testSummary.existingFailedTestCount testResults.existingFailedTests "${baseUrl}/images/iconsv3/plan_failed_16.png" baseUrl numTests maxTests showJob/]
        [/#if]
        [#if hasFixedTests]
            [@displayTestList "Fixed Tests" testSummary.fixedTestCaseCount testResults.fixedTests "${baseUrl}/images/iconsv3/plan_successful_16.png" baseUrl numTests maxTests showJob/]
        [/#if]
    [/#if]
[/#macro]
    ...
    [#assign jobResult = testResult.testClassResult.buildResultsSummary /]
        <tr>
            ...
            <td>
                ...
                <a href="${baseUrl}${fn.getTestCaseResultUrl(jobResult.buildKey, jobResult.buildNumber, testResult.testCase.id)}" class="test-name">${testResult.name?html}</a>
            </td>
            [#if showJob]
                <td>
                    <a href="${baseUrl}/browse/${jobResult.buildResultKey}/test">${jobResult.plan.buildName}</a>
                </td>
            [/#if]
        </tr>
[/#macro]
